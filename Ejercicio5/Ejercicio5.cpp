/*Un colegio desea saber que porcentaje de niños y que porcentaje de niñas hay en el curso actual. Diseñar un programa para este proposito.
...
total de niños y la cantidad total de niñas que hay en el curso.*/
#include <iostream>
using namespace std;
int main(){
